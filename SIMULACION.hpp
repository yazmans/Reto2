...
public:
    gota() { // constructor
        ...
        vector<double> possibleN={//esta cantidad de electrones de valencia es fisicamente imposible pero se asigna para darle un rango mayor a la simulacion, este vector puede ser modificado a gusto del usuario.
